Build a Survey Form
Hello, world! I make this page with HTML 5, CSS3, JavaScript, and Bootstrap 5 which I finish my first project in FreeCodeCamp's Responsive Web Design Certification Curriculum.

Here are the issues report that use the suggested technology stack (HTML, Plain CSS, JavaScript, Bootstrap or SASS) for this project:
